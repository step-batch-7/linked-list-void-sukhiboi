...
void test_add_to_start_when_list_is_empty(Element_creator creator)
{
    printf("\n-After adding one element\n");
    List_ptr list = create_list();
    add_to_start(list, creator(20));
...
void test_add_to_start_when_list_is_has_one_element(Element_creator creator)
{
    printf("\n-After adding two elements\n");
    List_ptr list = create_list();
    add_to_start(list, creator(20));
    add_to_start(list, creator(21));
    ...
    assert(*(Int_ptr)(list->first->element), 21, "Value of first element should be same as passed");
    assert(*(Int_ptr)(list->last->element), 20, "Value of last element should be same as passed");
}

void test_add_to_start_when_list_is_has_more_than_one_element(Element_creator creator)
{
    printf("\n-After adding three elements\n");
    List_ptr list = create_list();
    add_to_start(list, creator(20));
    add_to_start(list, creator(21));
    add_to_start(list, creator(22));
    ...
    assert(*(Int_ptr)(list->first->element), 22, "Value of first element should be same as passed");
...
void test_add_to_start(Element_creator creator)
{
    ...
    test_add_to_start_when_list_is_empty(creator);
    test_add_to_start_when_list_is_has_one_element(creator);
    test_add_to_start_when_list_is_has_more_than_one_element(creator);
}